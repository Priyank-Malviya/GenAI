...
# Configurations
PDF_FILE = os.getenv("PDF_FILE", "movies_trivia.pdf")
...
class MovieTriviaChatbot:
    """Movie Trivia Chatbot with RAG pipeline using Groq LLM"""
    ...
    def __init__(self):
        ...
        print("Movie Trivia Chatbot - Initializing")
        print("-" * 60)
    ...
    def _initialize_vector_store(self):
        ...
        self.vector_store = Chroma.from_documents(
            ...
            collection_name="movie_trivia_collection",
    ...
    def _create_rag_chain(self):
        ...
        prompt = ChatPromptTemplate.from_template("""You are MovieBot, an expert guide to Movie Trivia.
        Use the provided context about movies, actors, directors, and film history to answer questions.
        Be enthusiastic and engaging when discussing movies!
        Provide interesting trivia and fun facts when relevant.
You have context information about movies, actors, directors, and film history.
...
Answer:""")
    ...
    @traceable(name="movie_trivia_chatbot_query")
...
def create_gradio_interface(chatbot: MovieTriviaChatbot):    
    greeting = "Hello, I am MovieBot, your movie trivia expert. Ask me anything about films!"
    ...
    with gr.Blocks(
        title="Movie Trivia Chatbot",
        theme=gr.themes.Soft()
    ) as interface:
        gr.Markdown("""
        # Movie Trivia Chatbot
        ## Your Guide to Movies, Actors, Directors, and Film History
        """)
        ...
        with gr.Row():
            with gr.Column():
                user_input = gr.Textbox(
                    label="Your Question",
                    placeholder="Ask about Movies, Actors, Directors, and Film History...",
                    lines=3
                )
